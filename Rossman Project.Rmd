---
title: "Rossaman EDA"
author: "Team Awesome Incredible"
date: "February"
...
# we need to fix some issues with the stores dataframe before we merge the datasets!
d <- merge(x=sales,y=stores, by= "Store",all.x = TRUE)
```

Feature Engineering
```{r feature_engineering}
# fix promo2 stuff, etc. 
...
Bivariate Plots (sales vs variables)
